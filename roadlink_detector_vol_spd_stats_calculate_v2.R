...
sidefire_vol_spd_2022_am = data.frame(cbind(sidefire_linkmatch_frwy_2025$sf_id, sidefire_linkmatch_frwy_2025$sf_name,
                                            sidefire_linkmatch_frwy_2025$rdwy_id, sidefire_linkmatch_frwy_2025$rdwy_name))
...
for (i in 1:nrow(sidefire_vol_spd_2022_am)) {
  ...
  volarray_i = allNA_returnNA(t(link_i[,seq(46,55)])[spd_lowerff]) 
...
# initiate peak hour vol_speed statistical records 
# vol per day file obtained from sql server collected by detectors. the link ID corresponds to sensors ID
sidefire_vol_spd_2022_pm = data.frame(cbind(sidefire_linkmatch_frwy_2025$sf_id, sidefire_linkmatch_frwy_2025$sf_name,
                                            sidefire_linkmatch_frwy_2025$rdwy_id, sidefire_linkmatch_frwy_2025$rdwy_name))
...
# initiate peak hour vol_speed statistical records 
# vol per day file obtained from sql server collected by detectors. the link ID corresponds to sensors ID
sidefire_vol_spd_2022_op = data.frame(cbind(sidefire_linkmatch_frwy_2025$sf_id, sidefire_linkmatch_frwy_2025$sf_name,
                                            sidefire_linkmatch_frwy_2025$rdwy_id, sidefire_linkmatch_frwy_2025$rdwy_name))
...
sidefire_vol_spd_2022_op$oplane = 0 #; sidefire_vol_spd_2022_op$PMlane = 0
...
########################################### clear working environ #############################################
########################################### clear working environ #############################################
rm(i,spd_lowerff,spdarray_i,volarray_i,link_i,
   minIndex,maxIndex,q15Index,q25Index,q50Index,q75Index,q90Index,q99Index,q975Index,avgIndex,q85Index,q95Index, boxupperIndex)
