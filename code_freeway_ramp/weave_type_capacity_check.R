...
new_cols <- t(sapply(roadlink_weave[, c("WEAVE_T")], specs_type))
...
roadlink_weave %>%
  group_by(WEAVE_T) %>%
  summarise(mean_value = mean(hrcapperlane_hcm, na.rm = TRUE))

roadlink_weave %>%
  group_by(WEAVE_T) %>%
  summarise(std_value = sd(hrcapperlane_hcm, na.rm = TRUE))

roadlink_weave %>%
  group_by(WEAVE_T) %>%
  summarise(mean_value = mean(hrcapperlane, na.rm = TRUE))

roadlink_weave %>%
  group_by(WEAVE_T) %>%
  summarise(std_value = sd(hrcapperlane, na.rm = TRUE))
######################################################### functions #########################################################
######################################################### functions #########################################################
######################################################### functions #########################################################
